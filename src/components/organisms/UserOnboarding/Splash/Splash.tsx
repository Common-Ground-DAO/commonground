...
import CgLogoIcon from 'components/atoms/icons/misc/Logo/logo.svg?react';
import './Splash.css';
import Button from "components/atoms/Button/Button";
import { usePasskeyContext } from "context/PasskeyProvider";
import { ArrowLeftCircleIcon } from "@heroicons/react/24/solid";
import FaceIdIcon from './icons/faceId.svg?react';
import FingerPrintIcon from './icons/fingerPrint.svg?react';
import ComputerIcon from './icons/computerIcon.svg?react';
import PasskeyIcon from './icons/passkeyIcon.svg?react';
import StopWatchIcon from './icons/stopWatchIcon.svg?react';
