...
| ~~**OpenAI-compatible LLM**~~ | AI assistant | **REMOVED 2026-08-01** — the assistant process, queue, routes, tables, the `llama`/`assistant` compose services and `AI_API_KEY`/`AI_USE_GPU` are all gone | — | — |
